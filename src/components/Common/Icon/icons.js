const icons = {
  ...
  playFill: {
    ...
    viewBox: '0 0 24 24',
    paths: [
      'M19.5,11.2l-14-9C5.2,2,4.8,2,4.5,2.2C4.2,2.3,4,2.6,4,3v18c0,0.4,0.2,0.7,0.5,0.9C4.7,22,4.8,22,5,22s0.4-0.1,0.5-0.2l14-9c0.3-0.2,0.5-0.5,0.5-0.8S19.8,11.3,19.5,11.2z',
    ],
  },
  playOutline: {
    width: 24,
